...
// Vendored, unmodified copy of the canonical Chain.wtf casino game interface
// from `sdk.chain.wtf/casino` (casino-sdk/simulator/contracts/ICasinoGameV2.sol).
// Source of truth: the SDK package. Do not edit this file.
